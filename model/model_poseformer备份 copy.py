...
class PoseTransformer(nn.Module):
    def __init__(self, num_frame=3, in_num_joints=25, in_chans=3,out_num_joint=17,out_chans=1,embed_dim_ratio=32, 
                 depth=4, num_heads=8, mlp_ratio=2., qkv_bias=True, qk_scale=None,
                 drop_rate=0., attn_drop_rate=0., drop_path_rate=0.2,  norm_layer=None,angle_limit_rad=None):
        """
